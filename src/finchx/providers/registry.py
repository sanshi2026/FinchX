...
from finchx.datasets.article_detail import ARTICLE_DETAIL_DATASET
...
from finchx.providers.ths_articles import THSArticleDetailProvider
...
PROVIDER_SPECS = (
    ...
    _spec("tonghuashun.concept", TonghuashunConceptProvider,
          MARKET_CONCEPT_LIST_DATASET,
          MARKET_CONCEPT_QUOTE_SNAPSHOT_DATASET,
          MARKET_CONCEPT_OHLCV_DATASET, semantics=_SINGLE_SOURCE),
