...
class DisclosureDocumentRef(ContractModel):
    ...
    source_recorded_at: datetime | None = Field(default=None, alias="sourceRecordedAt")
...
def normalize_disclosure_document(
    ...
    *,
    ...
    if row.ei_time is not None and ref.source_recorded_at != row.ei_time:
        raise ValueError("document ref sourceRecordedAt does not match fetched content")
    ...
    data = DisclosureDocumentData(
        ...
        sourceRecordedAt=ref.source_recorded_at,
